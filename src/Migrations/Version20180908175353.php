 ...
 */
final class Version20180908175353 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE web_site (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', admin_user_id INT DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, is_online TINYINT(1) DEFAULT NULL, has_admin_chat TINYINT(1) NOT NULL, has_private_chat TINYINT(1) NOT NULL, is_wordpress TINYINT(1) DEFAULT NULL, admin_temp_user VARCHAR(255) DEFAULT NULL, installed TINYINT(1) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_AD4104116352511C (admin_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
