 ...
 */
final class Version20180915194605 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE chat_room (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', website_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', chat_type VARCHAR(255) NOT NULL, need_friend TINYINT(1) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_D403CCDA18F45C82 (website_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE web_site (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', admin_user_id INT DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, is_online TINYINT(1) DEFAULT NULL, has_admin_chat TINYINT(1) DEFAULT NULL, has_private_chat TINYINT(1) DEFAULT NULL, is_wordpress TINYINT(1) DEFAULT NULL, admin_temp_user VARCHAR(255) DEFAULT NULL, installed TINYINT(1) NOT NULL, source_code LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, deletedAt DATETIME DEFAULT NULL, INDEX IDX_AD4104116352511C (admin_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE chat_room ADD CONSTRAINT FK_D403CCDA18F45C82 FOREIGN KEY (website_id) REFERENCES web_site (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat_room DROP FOREIGN KEY FK_D403CCDA18F45C82');
